...
const translations = {
  en: {
    ...
    admin_label_title_en: 'Title (English)',
    admin_label_title_de: 'Title (German)',
    ...
    admin_placeholder_title_de: 'Optional — falls back to the English title if left blank',
  ...
  de: {
    ...
    admin_label_title_en: 'Titel (Englisch)',
    admin_label_title_de: 'Titel (Deutsch)',
    ...
    admin_placeholder_title_de: 'Optional — verwendet sonst den englischen Titel',
